Shader "NatureManufacture/Water/River Offset"
{
	Properties
	{
...
#define _AOPower_arr Graph_NM_River_SS
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			half clampResult683 = clamp( switchResult661 , 0.0 , 1.0 );
			#ifdef DIRECTIONAL_COOKIE
				half staticSwitch676 = clampResult683;
			#else
				half staticSwitch676 = 1.0;
			#endif
			o.Albedo = ( lerpResult640 * staticSwitch676 ).rgb;
			...
			half3 temp_cast_34 = (( lerpResult608 * staticSwitch676 )).xxx;
			...
			o.Occlusion = ( _AOPower_Instance * staticSwitch676 );
			o.Alpha = clampResult683;
		}
