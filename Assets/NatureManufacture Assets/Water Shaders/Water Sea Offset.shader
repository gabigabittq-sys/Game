Shader "NatureManufacture/Water/Sea Offset"
{
	Properties
	{
		...
		_BackfaceAlpha("Alpha Backface", Range( 0 , 1)) = 1
...
#define _AOPower_arr Graph_NM_Sea_SS
		...
		half3 InvertDepthDir72_g148( half3 In )
		{
			float3 result = In;
		...
		inline float4 TriplanarSampling25_g145( UNITY_DECLARE_TEX2D_NOSAMPLER(topTexMap), SamplerState samplertopTexMap, float3 worldPos, float3 worldNormal, float falloff, float2 tiling, float3 normalScale, float3 index )
		{
		...
		inline float4 TriplanarSampling26_g145( UNITY_DECLARE_TEX2D_NOSAMPLER(topTexMap), SamplerState samplertopTexMap, float3 worldPos, float3 worldNormal, float falloff, float2 tiling, float3 normalScale, float3 index )
		{
			float3 projNormal = ( pow( abs( worldNormal ), falloff ) );
			projNormal /= ( projNormal.x + projNormal.y + projNormal.z ) + 0.00001;
			float3 nsign = sign( worldNormal );
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			half2 temp_output_73_0_g223 = rotator864;
			half2 ifLocalVar77_g223 = 0;
			if( length( temp_output_73_0_g223 ) == 0.0 )
				ifLocalVar77_g223 = half2( 0.001,0 );
			else
				ifLocalVar77_g223 = temp_output_73_0_g223;
			half2 normalizeResult79_g223 = normalize( ifLocalVar77_g223 );
			half2 break80_g223 = normalizeResult79_g223;
			...
			half clampResult44_g155 = clamp( abs( ase_worldNormal.y ) , 0.0 , 1.0 );
			...
			half2 temp_output_66_0_g155 = temp_output_801_0;
			half2 temp_output_53_0_g155 = ( ( ( ( ( 1.0 - clampResult44_g155 ) * half2( 1,1 ) ) + ( ( float2( 1,1 ) / clampResult800 ) * float2( 1.8,1.8 ) ) ) * temp_output_66_0_g155 ) * v.texcoord3.xy );
			half2 break56_g155 = temp_output_53_0_g155;
			half2 appendResult57_g155 = (half2(break56_g155.y , break56_g155.x));
			#ifdef _UVVDIRECTION1UDIRECTION0_ON
				half2 staticSwitch59_g155 = temp_output_53_0_g155;
			#else
				half2 staticSwitch59_g155 = appendResult57_g155;
			#endif
			...
			half temp_output_68_0_g155 = ( ( _Time.y + TimeOffset843 ) * 0.07 );
			half temp_output_71_0_g155 = frac( ( temp_output_68_0_g155 + 0.0 ) );
			half2 temp_output_60_0_g155 = ( staticSwitch59_g155 * temp_output_71_0_g155 );
			...
			half2 temp_output_83_0_g155 = ( ( 1.0 / GlobalTiling70 ) * ( temp_output_66_0_g155 * v.texcoord.xy ) );
			half2 temp_output_80_0_g155 = ( staticSwitch59_g155 * frac( ( temp_output_68_0_g155 + -0.5 ) ) );
			half clampResult90_g155 = clamp( abs( sin( ( ( UNITY_PI * 1.5 ) + ( temp_output_71_0_g155 * UNITY_PI ) ) ) ) , 0.0 , 1.0 );
			half lerpResult791 = lerp( SAMPLE_TEXTURE2D_LOD( _Waves_Noise, sampler_Linear_Repeat_Aniso8, ( temp_output_60_0_g155 + temp_output_83_0_g155 ), 0.0 ).r , SAMPLE_TEXTURE2D_LOD( _Waves_Noise, sampler_Linear_Repeat_Aniso8, ( temp_output_83_0_g155 + temp_output_80_0_g155 ), 0.0 ).r , clampResult90_g155);
			...
			half clampResult44_g156 = clamp( abs( ase_worldNormal.y ) , 0.0 , 1.0 );
			...
			half2 temp_output_66_0_g156 = temp_output_779_0;
			half2 temp_output_53_0_g156 = ( ( ( ( ( 1.0 - clampResult44_g156 ) * half2( 1,1 ) ) + ( ( float2( 1,1 ) / clampResult780 ) * float2( 2,2 ) ) ) * temp_output_66_0_g156 ) * v.texcoord3.xy );
			half2 break56_g156 = temp_output_53_0_g156;
			half2 appendResult57_g156 = (half2(break56_g156.y , break56_g156.x));
			#ifdef _UVVDIRECTION1UDIRECTION0_ON
				half2 staticSwitch59_g156 = temp_output_53_0_g156;
			#else
				half2 staticSwitch59_g156 = appendResult57_g156;
			#endif
			half temp_output_68_0_g156 = ( ( _Time.y + TimeOffset843 ) * 0.05 );
			half temp_output_71_0_g156 = frac( ( temp_output_68_0_g156 + 0.0 ) );
			half2 temp_output_60_0_g156 = ( staticSwitch59_g156 * temp_output_71_0_g156 );
			half2 temp_output_83_0_g156 = ( ( 1.0 / GlobalTiling70 ) * ( temp_output_66_0_g156 * v.texcoord.xy ) );
			half2 temp_output_80_0_g156 = ( staticSwitch59_g156 * frac( ( temp_output_68_0_g156 + -0.5 ) ) );
			half clampResult90_g156 = clamp( abs( sin( ( ( UNITY_PI * 1.5 ) + ( temp_output_71_0_g156 * UNITY_PI ) ) ) ) , 0.0 , 1.0 );
			half lerpResult772 = lerp( SAMPLE_TEXTURE2D_LOD( _Waves_Noise, sampler_Linear_Repeat_Aniso8, ( temp_output_60_0_g156 + temp_output_83_0_g156 ), 0.0 ).r , SAMPLE_TEXTURE2D_LOD( _Waves_Noise, sampler_Linear_Repeat_Aniso8, ( temp_output_83_0_g156 + temp_output_80_0_g156 ), 0.0 ).r , clampResult90_g156);
			...
			half temp_output_83_0_g223 = clampResult859;
			half temp_output_61_0_g223 = ( ( UNITY_PI * 2.0 ) / _GerstnerDirection_5_Instance.w );
			half temp_output_82_0_g223 = ( temp_output_83_0_g223 / temp_output_61_0_g223 );
			float3 ase_worldPos = mul( unity_ObjectToWorld, v.vertex );
			half3 break70_g223 = ase_worldPos;
			half3 appendResult71_g223 = (half3(break70_g223.x , break70_g223.z , 0.0));
			half dotResult72_g223 = dot( half3( normalizeResult79_g223 ,  0.0 ) , appendResult71_g223 );
			half temp_output_841_0 = ( _Time.y + TimeOffset843 );
			half temp_output_81_0_g223 = ( temp_output_61_0_g223 * ( dotResult72_g223 - ( sqrt( ( 9.8 / temp_output_61_0_g223 ) ) * temp_output_841_0 ) ) );
			half temp_output_85_0_g223 = cos( temp_output_81_0_g223 );
			half temp_output_86_0_g223 = sin( temp_output_81_0_g223 );
			...
			half temp_output_89_0_g223 = ( clampResult856 * temp_output_849_0 );
			half temp_output_90_0_g223 = ( ( temp_output_82_0_g223 * temp_output_85_0_g223 ) + ( temp_output_86_0_g223 * temp_output_89_0_g223 ) );
			half3 appendResult94_g223 = (half3(( break80_g223.x * temp_output_90_0_g223 ) , ( temp_output_82_0_g223 * temp_output_86_0_g223 ) , ( break80_g223.y * temp_output_90_0_g223 )));
			...
			half2 temp_output_73_0_g224 = rotator862;
			half2 ifLocalVar77_g224 = 0;
			if( length( temp_output_73_0_g224 ) == 0.0 )
				ifLocalVar77_g224 = half2( 0.001,0 );
			else
				ifLocalVar77_g224 = temp_output_73_0_g224;
			half2 normalizeResult79_g224 = normalize( ifLocalVar77_g224 );
			half2 break80_g224 = normalizeResult79_g224;
			...
			half temp_output_83_0_g224 = clampResult847;
			half temp_output_61_0_g224 = ( ( UNITY_PI * 2.0 ) / _GerstnerDirection_4_Instance.w );
			half temp_output_82_0_g224 = ( temp_output_83_0_g224 / temp_output_61_0_g224 );
			half3 break70_g224 = ase_worldPos;
			half3 appendResult71_g224 = (half3(break70_g224.x , break70_g224.z , 0.0));
			half dotResult72_g224 = dot( half3( normalizeResult79_g224 ,  0.0 ) , appendResult71_g224 );
			half temp_output_81_0_g224 = ( temp_output_61_0_g224 * ( dotResult72_g224 - ( sqrt( ( 9.8 / temp_output_61_0_g224 ) ) * temp_output_841_0 ) ) );
			half temp_output_85_0_g224 = cos( temp_output_81_0_g224 );
			half temp_output_86_0_g224 = sin( temp_output_81_0_g224 );
			half clampResult852 = clamp( temp_output_825_0 , 0.0 , 1.0 );
			half temp_output_89_0_g224 = ( clampResult852 * temp_output_849_0 );
			half temp_output_90_0_g224 = ( ( temp_output_82_0_g224 * temp_output_85_0_g224 ) + ( temp_output_86_0_g224 * temp_output_89_0_g224 ) );
			half3 appendResult94_g224 = (half3(( break80_g224.x * temp_output_90_0_g224 ) , ( temp_output_82_0_g224 * temp_output_86_0_g224 ) , ( break80_g224.y * temp_output_90_0_g224 )));
			half2 appendResult908 = (half2(v.texcoord.z , v.texcoord.w));
			half2 temp_output_73_0_g225 = appendResult908;
			half2 ifLocalVar77_g225 = 0;
			if( length( temp_output_73_0_g225 ) == 0.0 )
				ifLocalVar77_g225 = half2( 0.001,0 );
			else
				ifLocalVar77_g225 = temp_output_73_0_g225;
			half2 normalizeResult79_g225 = normalize( ifLocalVar77_g225 );
			half2 break80_g225 = normalizeResult79_g225;
			...
			half temp_output_83_0_g225 = clampResult901;
			half temp_output_61_0_g225 = ( ( UNITY_PI * 2.0 ) / _GerstnerDirection_1_Instance.w );
			half temp_output_82_0_g225 = ( temp_output_83_0_g225 / temp_output_61_0_g225 );
			...
			half temp_output_67_0_g214 = _Polar_and_Small_Waves_Friction_Depth_Mask_Instance;
			half clampResult135_g214 = clamp( v.texcoord3.w , 0.0 , temp_output_67_0_g214 );
			...
			half temp_output_81_0_g225 = ( temp_output_61_0_g225 * ( ( -1.0 * length( ifLocalVar77_g225 ) ) - ( sqrt( ( 9.8 / temp_output_61_0_g225 ) ) * ( ( ( _Time.y + TimeOffset843 ) - ( 0.3 * temp_output_912_0 ) ) - ( pow( abs( (1.0 + (clampResult135_g214 - 0.0) * (0.0 - 1.0) / (temp_output_67_0_g214 - 0.0)) ) , _Polar_and_Small_Waves_Friction_Depth_Mask_Power_Instance ) * _Polar_and_Small_Waves_Friction_Speed_Reduction_Instance ) ) ) ) );
			half temp_output_85_0_g225 = cos( temp_output_81_0_g225 );
			half temp_output_86_0_g225 = sin( temp_output_81_0_g225 );
			half temp_output_89_0_g225 = temp_output_912_0;
			half temp_output_90_0_g225 = ( ( temp_output_82_0_g225 * temp_output_85_0_g225 ) + ( temp_output_86_0_g225 * temp_output_89_0_g225 ) );
			half3 appendResult94_g225 = (half3(( ( break80_g225.x * -1.0 ) * temp_output_90_0_g225 ) , ( temp_output_82_0_g225 * temp_output_86_0_g225 ) , ( ( break80_g225.y * -1.0 ) * temp_output_90_0_g225 )));
			...
			half2 temp_output_73_0_g221 = rotator932;
			half2 ifLocalVar77_g221 = 0;
			if( length( temp_output_73_0_g221 ) == 0.0 )
				ifLocalVar77_g221 = half2( 0.001,0 );
			else
				ifLocalVar77_g221 = temp_output_73_0_g221;
			half2 normalizeResult79_g221 = normalize( ifLocalVar77_g221 );
			half2 break80_g221 = normalizeResult79_g221;
			...
			half temp_output_83_0_g221 = clampResult1000;
			half temp_output_61_0_g221 = ( ( UNITY_PI * 2.0 ) / _Gerstner_1_Instance.w );
			half temp_output_82_0_g221 = ( temp_output_83_0_g221 / temp_output_61_0_g221 );
			half3 break70_g221 = ase_worldPos;
			half3 appendResult71_g221 = (half3(break70_g221.x , break70_g221.z , 0.0));
			half dotResult72_g221 = dot( half3( normalizeResult79_g221 ,  0.0 ) , appendResult71_g221 );
			...
			half temp_output_67_0_g212 = _Polar_and_Small_Waves_Friction_Depth_Mask_Instance;
			half clampResult135_g212 = clamp( v.texcoord3.w , 0.0 , temp_output_67_0_g212 );
			half temp_output_81_0_g221 = ( temp_output_61_0_g221 * ( dotResult72_g221 - ( sqrt( ( 9.8 / temp_output_61_0_g221 ) ) * ( ( temp_output_964_0 - ( 0.3 * clampResult996 ) ) - ( pow( abs( (1.0 + (clampResult135_g212 - 0.0) * (0.0 - 1.0) / (temp_output_67_0_g212 - 0.0)) ) , _Polar_and_Small_Waves_Friction_Depth_Mask_Power_Instance ) * _Polar_and_Small_Waves_Friction_Speed_Reduction_Instance ) ) ) ) );
			half temp_output_85_0_g221 = cos( temp_output_81_0_g221 );
			half temp_output_86_0_g221 = sin( temp_output_81_0_g221 );
			half temp_output_89_0_g221 = clampResult996;
			half temp_output_90_0_g221 = ( ( temp_output_82_0_g221 * temp_output_85_0_g221 ) + ( temp_output_86_0_g221 * temp_output_89_0_g221 ) );
			half3 appendResult94_g221 = (half3(( break80_g221.x * temp_output_90_0_g221 ) , ( temp_output_82_0_g221 * temp_output_86_0_g221 ) , ( break80_g221.y * temp_output_90_0_g221 )));
			...
			half2 temp_output_73_0_g222 = rotator931;
			half2 ifLocalVar77_g222 = 0;
			if( length( temp_output_73_0_g222 ) == 0.0 )
				ifLocalVar77_g222 = half2( 0.001,0 );
			else
				ifLocalVar77_g222 = temp_output_73_0_g222;
			half2 normalizeResult79_g222 = normalize( ifLocalVar77_g222 );
			half2 break80_g222 = normalizeResult79_g222;
			...
			half temp_output_83_0_g222 = clampResult1005;
			half temp_output_61_0_g222 = ( ( UNITY_PI * 2.0 ) / _Gerstner_2_Instance.w );
			half temp_output_82_0_g222 = ( temp_output_83_0_g222 / temp_output_61_0_g222 );
			half3 break70_g222 = ase_worldPos;
			half3 appendResult71_g222 = (half3(break70_g222.x , break70_g222.z , 0.0));
			half dotResult72_g222 = dot( half3( normalizeResult79_g222 ,  0.0 ) , appendResult71_g222 );
			...
			half temp_output_67_0_g213 = _Polar_and_Small_Waves_Friction_Depth_Mask_Instance;
			half clampResult135_g213 = clamp( v.texcoord3.w , 0.0 , temp_output_67_0_g213 );
			half temp_output_81_0_g222 = ( temp_output_61_0_g222 * ( dotResult72_g222 - ( sqrt( ( 9.8 / temp_output_61_0_g222 ) ) * ( ( temp_output_964_0 - ( 0.3 * clampResult1001 ) ) - ( pow( abs( (1.0 + (clampResult135_g213 - 0.0) * (0.0 - 1.0) / (temp_output_67_0_g213 - 0.0)) ) , _Polar_and_Small_Waves_Friction_Depth_Mask_Power_Instance ) * _Polar_and_Small_Waves_Friction_Speed_Reduction_Instance ) ) ) ) );
			half temp_output_85_0_g222 = cos( temp_output_81_0_g222 );
			half temp_output_86_0_g222 = sin( temp_output_81_0_g222 );
			half temp_output_89_0_g222 = clampResult1001;
			half temp_output_90_0_g222 = ( ( temp_output_82_0_g222 * temp_output_85_0_g222 ) + ( temp_output_86_0_g222 * temp_output_89_0_g222 ) );
			half3 appendResult94_g222 = (half3(( break80_g222.x * temp_output_90_0_g222 ) , ( temp_output_82_0_g222 * temp_output_86_0_g222 ) , ( break80_g222.y * temp_output_90_0_g222 )));
			half3 temp_output_1078_0 = ( ( ( appendResult94_g223 + ( appendResult94_g224 + appendResult94_g225 ) ) + appendResult94_g221 ) + appendResult94_g222 );
			half clampResult44_g154 = clamp( abs( ase_worldNormal.y ) , 0.0 , 1.0 );
			...
			half2 temp_output_66_0_g154 = WaterTiling693;
			half2 temp_output_53_0_g154 = ( ( ( ( ( 1.0 - clampResult44_g154 ) * SeaFoamSlopeInfluence701 ) + MainWaterSpeed692 ) * temp_output_66_0_g154 ) * v.texcoord3.xy );
			half2 break56_g154 = temp_output_53_0_g154;
			half2 appendResult57_g154 = (half2(break56_g154.y , break56_g154.x));
			#ifdef _UVVDIRECTION1UDIRECTION0_ON
				half2 staticSwitch59_g154 = temp_output_53_0_g154;
			#else
				half2 staticSwitch59_g154 = appendResult57_g154;
			#endif
			...
			half temp_output_68_0_g154 = ( ( _Time.y + 0.0 ) * WaterFlowUVRefreshSpeed695 );
			half temp_output_71_0_g154 = frac( ( temp_output_68_0_g154 + 0.0 ) );
			half2 temp_output_60_0_g154 = ( staticSwitch59_g154 * temp_output_71_0_g154 );
			half2 temp_output_83_0_g154 = ( ( 1.0 / GlobalTiling70 ) * ( temp_output_66_0_g154 * v.texcoord.xy ) );
			half2 temp_output_1615_91 = ( temp_output_60_0_g154 + temp_output_83_0_g154 );
			half _SlowNormalScale_Instance = UNITY_ACCESS_INSTANCED_PROP(_SlowNormalScale_arr, _SlowNormalScale);
			half2 temp_output_80_0_g154 = ( staticSwitch59_g154 * frac( ( temp_output_68_0_g154 + -0.5 ) ) );
			half2 temp_output_1615_93 = ( temp_output_83_0_g154 + temp_output_80_0_g154 );
			half clampResult90_g154 = clamp( abs( sin( ( ( UNITY_PI * 1.5 ) + ( temp_output_71_0_g154 * UNITY_PI ) ) ) ) , 0.0 , 1.0 );
			half temp_output_1615_96 = clampResult90_g154;
			half3 lerpResult80 = lerp( UnpackScaleNormal( SAMPLE_TEXTURE2D_LOD( _SlowWaterNormal, sampler_Linear_Repeat_Aniso8, temp_output_1615_91, 0.0 ), _SlowNormalScale_Instance ) , UnpackScaleNormal( SAMPLE_TEXTURE2D_LOD( _SlowWaterNormal, sampler_Linear_Repeat_Aniso8, temp_output_1615_93, 0.0 ), _SlowNormalScale_Instance ) , temp_output_1615_96);
			...
			half lerpResult81 = lerp( SAMPLE_TEXTURE2D_LOD( _SlowWaterTesselation, sampler_Linear_Repeat_Aniso8, temp_output_1615_91, 0.0 ).r , SAMPLE_TEXTURE2D_LOD( _SlowWaterTesselation, sampler_Linear_Repeat_Aniso8, temp_output_1615_93, 0.0 ).r , temp_output_1615_96);
			...
			v.vertex.xyz += ( ( ( temp_output_1078_0 + float3( 0,0,0 ) ) + ( lerpResult1133 * ase_worldNormal ) ) + float3( 0,0,0 ) );
			v.vertex.w = 1;
			...
			half temp_output_95_0_g223 = ( temp_output_86_0_g223 * temp_output_83_0_g223 );
			half temp_output_1640_0 = distance( ase_worldPos , _WorldSpaceCameraPos );
			half clampResult126_g223 = clamp( temp_output_1640_0 , 0.0 , 100.0 );
			half clampResult130_g223 = clamp( ( ( ( clampResult126_g223 * 0.01 ) * temp_output_89_0_g223 ) + -1.0 ) , -0.6 , 0.0 );
			half clampResult132_g223 = clamp( temp_output_85_0_g223 , clampResult130_g223 , 1.0 );
			half temp_output_104_0_g223 = ( ( clampResult132_g223 * temp_output_61_0_g223 ) * temp_output_89_0_g223 );
			half temp_output_114_0_g223 = ( ( ( break80_g223.y * -1.0 ) * temp_output_95_0_g223 ) + ( break80_g223.y * temp_output_104_0_g223 ) );
			half temp_output_96_0_g223 = ( clampResult132_g223 * temp_output_83_0_g223 );
			half3 appendResult120_g223 = (half3(( break80_g223.x * temp_output_114_0_g223 ) , ( break80_g223.y * temp_output_96_0_g223 ) , ( break80_g223.y * temp_output_114_0_g223 )));
			half temp_output_95_0_g224 = ( temp_output_86_0_g224 * temp_output_83_0_g224 );
			half clampResult126_g224 = clamp( temp_output_1640_0 , 0.0 , 100.0 );
			half clampResult130_g224 = clamp( ( ( ( clampResult126_g224 * 0.01 ) * temp_output_89_0_g224 ) + -1.0 ) , -0.6 , 0.0 );
			half clampResult132_g224 = clamp( temp_output_85_0_g224 , clampResult130_g224 , 1.0 );
			half temp_output_104_0_g224 = ( ( clampResult132_g224 * temp_output_61_0_g224 ) * temp_output_89_0_g224 );
			half temp_output_114_0_g224 = ( ( ( break80_g224.y * -1.0 ) * temp_output_95_0_g224 ) + ( break80_g224.y * temp_output_104_0_g224 ) );
			half temp_output_96_0_g224 = ( clampResult132_g224 * temp_output_83_0_g224 );
			half3 appendResult120_g224 = (half3(( break80_g224.x * temp_output_114_0_g224 ) , ( break80_g224.y * temp_output_96_0_g224 ) , ( break80_g224.y * temp_output_114_0_g224 )));
			half clampResult144_g225 = clamp( temp_output_1640_0 , 0.0 , 100.0 );
			half clampResult146_g225 = clamp( ( ( ( clampResult144_g225 * 0.01 ) * temp_output_89_0_g225 ) + -1.0 ) , -0.6 , 0.0 );
			half clampResult147_g225 = clamp( temp_output_85_0_g225 , clampResult146_g225 , 1.0 );
			half temp_output_127_0_g225 = ( -1.0 / 1.0 );
			half temp_output_136_0_g225 = ( ( ( ( temp_output_83_0_g225 * -1.0 ) * temp_output_86_0_g225 ) + ( ( temp_output_61_0_g225 * clampResult147_g225 ) * temp_output_89_0_g225 ) ) * temp_output_127_0_g225 );
			half temp_output_138_0_g225 = ( break80_g225.y * temp_output_136_0_g225 );
			half temp_output_131_0_g225 = ( ( clampResult147_g225 * temp_output_83_0_g225 ) * temp_output_127_0_g225 );
			half3 appendResult120_g225 = (half3(( break80_g225.x * temp_output_138_0_g225 ) , ( break80_g225.y * temp_output_131_0_g225 ) , ( break80_g225.y * temp_output_138_0_g225 )));
			half temp_output_95_0_g221 = ( temp_output_86_0_g221 * temp_output_83_0_g221 );
			half clampResult126_g221 = clamp( temp_output_1640_0 , 0.0 , 100.0 );
			half clampResult130_g221 = clamp( ( ( ( clampResult126_g221 * 0.01 ) * temp_output_89_0_g221 ) + -1.0 ) , -0.6 , 0.0 );
			half clampResult132_g221 = clamp( temp_output_85_0_g221 , clampResult130_g221 , 1.0 );
			half temp_output_104_0_g221 = ( ( clampResult132_g221 * temp_output_61_0_g221 ) * temp_output_89_0_g221 );
			half temp_output_114_0_g221 = ( ( ( break80_g221.y * -1.0 ) * temp_output_95_0_g221 ) + ( break80_g221.y * temp_output_104_0_g221 ) );
			half temp_output_96_0_g221 = ( clampResult132_g221 * temp_output_83_0_g221 );
			half3 appendResult120_g221 = (half3(( break80_g221.x * temp_output_114_0_g221 ) , ( break80_g221.y * temp_output_96_0_g221 ) , ( break80_g221.y * temp_output_114_0_g221 )));
			half temp_output_95_0_g222 = ( temp_output_86_0_g222 * temp_output_83_0_g222 );
			half clampResult126_g222 = clamp( temp_output_1640_0 , 0.0 , 100.0 );
			half clampResult130_g222 = clamp( ( ( ( clampResult126_g222 * 0.01 ) * temp_output_89_0_g222 ) + -1.0 ) , -0.6 , 0.0 );
			half clampResult132_g222 = clamp( temp_output_85_0_g222 , clampResult130_g222 , 1.0 );
			half temp_output_104_0_g222 = ( ( clampResult132_g222 * temp_output_61_0_g222 ) * temp_output_89_0_g222 );
			half temp_output_114_0_g222 = ( ( ( break80_g222.y * -1.0 ) * temp_output_95_0_g222 ) + ( break80_g222.y * temp_output_104_0_g222 ) );
			half temp_output_96_0_g222 = ( clampResult132_g222 * temp_output_83_0_g222 );
			half3 appendResult120_g222 = (half3(( break80_g222.x * temp_output_114_0_g222 ) , ( break80_g222.y * temp_output_96_0_g222 ) , ( break80_g222.y * temp_output_114_0_g222 )));
			half temp_output_101_0_g223 = ( ( ( break80_g223.x * -1.0 ) * temp_output_95_0_g223 ) + ( break80_g223.x * temp_output_104_0_g223 ) );
			half3 appendResult110_g223 = (half3(( break80_g223.x * temp_output_101_0_g223 ) , ( break80_g223.x * temp_output_96_0_g223 ) , ( break80_g223.y * temp_output_101_0_g223 )));
			half temp_output_101_0_g224 = ( ( ( break80_g224.x * -1.0 ) * temp_output_95_0_g224 ) + ( break80_g224.x * temp_output_104_0_g224 ) );
			half3 appendResult110_g224 = (half3(( break80_g224.x * temp_output_101_0_g224 ) , ( break80_g224.x * temp_output_96_0_g224 ) , ( break80_g224.y * temp_output_101_0_g224 )));
			half temp_output_137_0_g225 = ( break80_g225.x * temp_output_136_0_g225 );
			half3 appendResult110_g225 = (half3(( break80_g225.x * temp_output_137_0_g225 ) , ( break80_g225.x * temp_output_131_0_g225 ) , ( break80_g225.y * temp_output_137_0_g225 )));
			half temp_output_101_0_g221 = ( ( ( break80_g221.x * -1.0 ) * temp_output_95_0_g221 ) + ( break80_g221.x * temp_output_104_0_g221 ) );
			half3 appendResult110_g221 = (half3(( break80_g221.x * temp_output_101_0_g221 ) , ( break80_g221.x * temp_output_96_0_g221 ) , ( break80_g221.y * temp_output_101_0_g221 )));
			half temp_output_101_0_g222 = ( ( ( break80_g222.x * -1.0 ) * temp_output_95_0_g222 ) + ( break80_g222.x * temp_output_104_0_g222 ) );
			half3 appendResult110_g222 = (half3(( break80_g222.x * temp_output_101_0_g222 ) , ( break80_g222.x * temp_output_96_0_g222 ) , ( break80_g222.y * temp_output_101_0_g222 )));
			half3 normalizeResult1099 = normalize( cross( ( half3(0,0,1) + ( ase_vertexBitangent + ( ( ( ( appendResult120_g223 + float3( 0,0,0 ) ) + ( ( appendResult120_g224 + float3( 0,0,0 ) ) + ( ( appendResult120_g225 * float3( -1,1,-1 ) ) + float3( 0,0,0 ) ) ) ) + ( appendResult120_g221 + float3( 0,0,0 ) ) ) + ( appendResult120_g222 + float3( 0,0,0 ) ) ) ) ) , ( half3(1,0,0) + ( ase_vertexTangent.xyz + ( ( ( ( appendResult110_g223 + float3( 0,0,0 ) ) + ( ( appendResult110_g224 + float3( 0,0,0 ) ) + ( ( appendResult110_g225 * float3( -1,1,-1 ) ) + float3( 0,0,0 ) ) ) ) + ( appendResult110_g221 + float3( 0,0,0 ) ) ) + ( appendResult110_g222 + float3( 0,0,0 ) ) ) ) ) ) );
			v.normal = ( normalizeResult1099 + float3( 0,0,0 ) );
			o.vertexToFrag1514 = temp_output_1078_0;
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			half2 WaterTiling693 = _SlowWaterTiling_Instance;
			half2 temp_output_66_0_g154 = WaterTiling693;
			half2 temp_output_53_0_g154 = ( ( ( ( ( 1.0 - clampResult44_g154 ) * SeaFoamSlopeInfluence701 ) + MainWaterSpeed692 ) * temp_output_66_0_g154 ) * i.uv4_texcoord4.xy );
			half2 break56_g154 = temp_output_53_0_g154;
			half2 appendResult57_g154 = (half2(break56_g154.y , break56_g154.x));
			#ifdef _UVVDIRECTION1UDIRECTION0_ON
				half2 staticSwitch59_g154 = temp_output_53_0_g154;
			...
			half _GlobalTiling_Instance = UNITY_ACCESS_INSTANCED_PROP(_GlobalTiling_arr, _GlobalTiling);
			half GlobalTiling70 = _GlobalTiling_Instance;
			half2 temp_output_83_0_g154 = ( ( 1.0 / GlobalTiling70 ) * ( temp_output_66_0_g154 * i.uv_texcoord.xy ) );
			half2 temp_output_1615_91 = ( temp_output_60_0_g154 + temp_output_83_0_g154 );
			half _SlowNormalScale_Instance = UNITY_ACCESS_INSTANCED_PROP(_SlowNormalScale_arr, _SlowNormalScale);
			half2 temp_output_80_0_g154 = ( staticSwitch59_g154 * frac( ( temp_output_68_0_g154 + -0.5 ) ) );
			half2 temp_output_1615_93 = ( temp_output_83_0_g154 + temp_output_80_0_g154 );
			half clampResult90_g154 = clamp( abs( sin( ( ( UNITY_PI * 1.5 ) + ( temp_output_71_0_g154 * UNITY_PI ) ) ) ) , 0.0 , 1.0 );
			half temp_output_1615_96 = clampResult90_g154;
			half3 lerpResult80 = lerp( UnpackScaleNormal( SAMPLE_TEXTURE2D( _SlowWaterNormal, sampler_Linear_Repeat_Aniso8, temp_output_1615_91 ), _SlowNormalScale_Instance ) , UnpackScaleNormal( SAMPLE_TEXTURE2D( _SlowWaterNormal, sampler_Linear_Repeat_Aniso8, temp_output_1615_93 ), _SlowNormalScale_Instance ) , temp_output_1615_96);
			half2 _SlowWaterMixSpeed_Instance = UNITY_ACCESS_INSTANCED_PROP(_SlowWaterMixSpeed_arr, _SlowWaterMixSpeed);
			...
			half2 temp_output_65_0_g43 = _Side_Foam_Speed_Instance;
			...
			half2 temp_output_66_0_g43 = _Side_Foam_Tiling_Instance;
			half2 temp_output_53_0_g43 = ( ( ( temp_output_65_0_g43 + ( temp_output_65_0_g43 * ( abs( pow( abs( (_Vector0.z + (ase_worldNormal.y - _Vector0.x) * (_Vector0.w - _Vector0.z) / (_Vector0.y - _Vector0.x)) ) , 0.5 ) ) * ( _Side_Foam_Slope_Speed_Influence_Instance * half2( -1,-1 ) ) ) ) ) * temp_output_66_0_g43 ) * i.uv4_texcoord4.xy );
			half2 break56_g43 = temp_output_53_0_g43;
			half2 appendResult57_g43 = (half2(break56_g43.y , break56_g43.x));
			#ifdef _UVVDIRECTION1UDIRECTION0_ON
				half2 staticSwitch59_g43 = temp_output_53_0_g43;
			#else
				half2 staticSwitch59_g43 = appendResult57_g43;
			#endif
			...
			half temp_output_68_0_g43 = ( _Time.y * _Side_Foam_Flow_UV_Refresh_Speed_Instance );
			half temp_output_71_0_g43 = frac( ( temp_output_68_0_g43 + 0.0 ) );
			half2 temp_output_60_0_g43 = ( staticSwitch59_g43 * temp_output_71_0_g43 );
			half2 temp_output_83_0_g43 = ( ( 1.0 / GlobalTiling70 ) * ( temp_output_66_0_g43 * i.uv_texcoord.xy ) );
			half2 temp_output_94_91 = ( temp_output_60_0_g43 + temp_output_83_0_g43 );
			...
			half2 temp_output_80_0_g43 = ( staticSwitch59_g43 * frac( ( temp_output_68_0_g43 + -0.5 ) ) );
			half2 temp_output_94_93 = ( temp_output_83_0_g43 + temp_output_80_0_g43 );
			half clampResult90_g43 = clamp( abs( sin( ( ( UNITY_PI * 1.5 ) + ( temp_output_71_0_g43 * UNITY_PI ) ) ) ) , 0.0 , 1.0 );
			half temp_output_94_96 = clampResult90_g43;
			...
			half temp_output_841_0 = ( _Time.y + TimeOffset843 );
			half temp_output_81_0_g224 = ( temp_output_61_0_g224 * ( dotResult72_g224 - ( sqrt( ( 9.8 / temp_output_61_0_g224 ) ) * temp_output_841_0 ) ) );
			half temp_output_1690_56 = ( ( ( ( ( UNITY_PI * 0.5 ) - ( temp_output_81_0_g224 + -3.8 ) ) % ( UNITY_PI * 2.0 ) ) / UNITY_PI ) + -1.0 );
			half clampResult1184 = clamp( temp_output_1690_56 , 0.0 , 1.0 );
			half clampResult1185 = clamp( temp_output_1690_56 , -1.0 , 1.0 );
			half4 _GerstnerDirection_5_Instance = UNITY_ACCESS_INSTANCED_PROP(_GerstnerDirection_5_arr, _GerstnerDirection_5);
			half temp_output_61_0_g223 = ( ( UNITY_PI * 2.0 ) / _GerstnerDirection_5_Instance.w );
			float cos864 = cos( ( ( ( _GerstnerDirection_5_Instance.z * _Sea_Waves_Chaos_Instance ) + 180.0 ) * 0.01745 ) );
			float sin864 = sin( ( ( ( _GerstnerDirection_5_Instance.z * _Sea_Waves_Chaos_Instance ) + 180.0 ) * 0.01745 ) );
			...
			half dotResult72_g223 = dot( half3( normalizeResult79_g223 ,  0.0 ) , appendResult71_g223 );
			half temp_output_81_0_g223 = ( temp_output_61_0_g223 * ( dotResult72_g223 - ( sqrt( ( 9.8 / temp_output_61_0_g223 ) ) * temp_output_841_0 ) ) );
			half temp_output_1689_56 = ( ( ( ( ( UNITY_PI * 0.5 ) - ( temp_output_81_0_g223 + -3.8 ) ) % ( UNITY_PI * 2.0 ) ) / UNITY_PI ) + -1.0 );
			half clampResult1189 = clamp( temp_output_1689_56 , 0.0 , 1.0 );
			half clampResult1190 = clamp( temp_output_1689_56 , -1.0 , 1.0 );
			...
			half2 clampResult780 = clamp( temp_output_779_0 , float2( 0.001,0.001 ) , float2( 500,500 ) );
			half2 temp_output_66_0_g156 = temp_output_779_0;
			half2 temp_output_53_0_g156 = ( ( ( ( ( 1.0 - clampResult44_g156 ) * half2( 1,1 ) ) + ( ( float2( 1,1 ) / clampResult780 ) * float2( 2,2 ) ) ) * temp_output_66_0_g156 ) * i.uv4_texcoord4.xy );
			half2 break56_g156 = temp_output_53_0_g156;
			half2 appendResult57_g156 = (half2(break56_g156.y , break56_g156.x));
			#ifdef _UVVDIRECTION1UDIRECTION0_ON
				half2 staticSwitch59_g156 = temp_output_53_0_g156;
			...
			half temp_output_71_0_g156 = frac( ( temp_output_68_0_g156 + 0.0 ) );
			half2 temp_output_60_0_g156 = ( staticSwitch59_g156 * temp_output_71_0_g156 );
			half2 temp_output_83_0_g156 = ( ( 1.0 / GlobalTiling70 ) * ( temp_output_66_0_g156 * i.uv_texcoord.xy ) );
			half2 temp_output_80_0_g156 = ( staticSwitch59_g156 * frac( ( temp_output_68_0_g156 + -0.5 ) ) );
			half clampResult90_g156 = clamp( abs( sin( ( ( UNITY_PI * 1.5 ) + ( temp_output_71_0_g156 * UNITY_PI ) ) ) ) , 0.0 , 1.0 );
			half lerpResult772 = lerp( SAMPLE_TEXTURE2D( _Waves_Noise, sampler_Linear_Repeat_Aniso8, ( temp_output_60_0_g156 + temp_output_83_0_g156 ) ).r , SAMPLE_TEXTURE2D( _Waves_Noise, sampler_Linear_Repeat_Aniso8, ( temp_output_83_0_g156 + temp_output_80_0_g156 ) ).r , clampResult90_g156);
			half _Small_Wave_Noise_Power_Instance = UNITY_ACCESS_INSTANCED_PROP(_Small_Wave_Noise_Power_arr, _Small_Wave_Noise_Power);
			half _Small_Wave_Noise_Multiply_Instance = UNITY_ACCESS_INSTANCED_PROP(_Small_Wave_Noise_Multiply_arr, _Small_Wave_Noise_Multiply);
			half clampResult787 = clamp( ( pow( abs( lerpResult772 ) , _Small_Wave_Noise_Power_Instance ) * _Small_Wave_Noise_Multiply_Instance ) , 0.0 , 1.0 );
			half temp_output_788_0 = (0.0 + (clampResult787 - 0.0) * (0.97 - 0.0) / (1.0 - 0.0));
			...
			half2 clampResult800 = clamp( temp_output_801_0 , float2( 0.001,0.001 ) , float2( 500,500 ) );
			half2 temp_output_66_0_g155 = temp_output_801_0;
			half2 temp_output_53_0_g155 = ( ( ( ( ( 1.0 - clampResult44_g155 ) * half2( 1,1 ) ) + ( ( float2( 1,1 ) / clampResult800 ) * float2( 1.8,1.8 ) ) ) * temp_output_66_0_g155 ) * i.uv4_texcoord4.xy );
			half2 break56_g155 = temp_output_53_0_g155;
			half2 appendResult57_g155 = (half2(break56_g155.y , break56_g155.x));
			#ifdef _UVVDIRECTION1UDIRECTION0_ON
				half2 staticSwitch59_g155 = temp_output_53_0_g155;
			...
			half temp_output_71_0_g155 = frac( ( temp_output_68_0_g155 + 0.0 ) );
			half2 temp_output_60_0_g155 = ( staticSwitch59_g155 * temp_output_71_0_g155 );
			half2 temp_output_83_0_g155 = ( ( 1.0 / GlobalTiling70 ) * ( temp_output_66_0_g155 * i.uv_texcoord.xy ) );
			half2 temp_output_80_0_g155 = ( staticSwitch59_g155 * frac( ( temp_output_68_0_g155 + -0.5 ) ) );
			half clampResult90_g155 = clamp( abs( sin( ( ( UNITY_PI * 1.5 ) + ( temp_output_71_0_g155 * UNITY_PI ) ) ) ) , 0.0 , 1.0 );
			half lerpResult791 = lerp( SAMPLE_TEXTURE2D( _Waves_Noise, sampler_Linear_Repeat_Aniso8, ( temp_output_60_0_g155 + temp_output_83_0_g155 ) ).r , SAMPLE_TEXTURE2D( _Waves_Noise, sampler_Linear_Repeat_Aniso8, ( temp_output_83_0_g155 + temp_output_80_0_g155 ) ).r , clampResult90_g155);
			half _Sea_Wave_Noise_Power_Instance = UNITY_ACCESS_INSTANCED_PROP(_Sea_Wave_Noise_Power_arr, _Sea_Wave_Noise_Power);
			half _Sea_Wave_Noise_Multiply_Instance = UNITY_ACCESS_INSTANCED_PROP(_Sea_Wave_Noise_Multiply_arr, _Sea_Wave_Noise_Multiply);
			half clampResult807 = clamp( ( pow( abs( lerpResult791 ) , _Sea_Wave_Noise_Power_Instance ) * _Sea_Wave_Noise_Multiply_Instance ) , 0.0 , 1.0 );
			half clampResult827 = clamp( ( 1.0 - (0.05 + (clampResult807 - 0.0) * (0.97 - 0.05) / (1.0 - 0.0)) ) , 0.0 , 1.0 );
			...
			half _Polar_and_Small_Waves_Friction_Depth_Mask_Instance = UNITY_ACCESS_INSTANCED_PROP(_Polar_and_Small_Waves_Friction_Depth_Mask_arr, _Polar_and_Small_Waves_Friction_Depth_Mask);
			half temp_output_67_0_g214 = _Polar_and_Small_Waves_Friction_Depth_Mask_Instance;
			half clampResult135_g214 = clamp( i.uv4_texcoord4.w , 0.0 , temp_output_67_0_g214 );
			half _Polar_and_Small_Waves_Friction_Depth_Mask_Power_Instance = UNITY_ACCESS_INSTANCED_PROP(_Polar_and_Small_Waves_Friction_Depth_Mask_Power_arr, _Polar_and_Small_Waves_Friction_Depth_Mask_Power);
			half _Polar_and_Small_Waves_Friction_Speed_Reduction_Instance = UNITY_ACCESS_INSTANCED_PROP(_Polar_and_Small_Waves_Friction_Speed_Reduction_arr, _Polar_and_Small_Waves_Friction_Speed_Reduction);
			half temp_output_81_0_g225 = ( temp_output_61_0_g225 * ( ( -1.0 * length( ifLocalVar77_g225 ) ) - ( sqrt( ( 9.8 / temp_output_61_0_g225 ) ) * ( ( ( _Time.y + TimeOffset843 ) - ( 0.3 * temp_output_912_0 ) ) - ( pow( abs( (1.0 + (clampResult135_g214 - 0.0) * (0.0 - 1.0) / (temp_output_67_0_g214 - 0.0)) ) , _Polar_and_Small_Waves_Friction_Depth_Mask_Power_Instance ) * _Polar_and_Small_Waves_Friction_Speed_Reduction_Instance ) ) ) ) );
			half temp_output_85_0_g225 = cos( temp_output_81_0_g225 );
			...
			half temp_output_90_0_g225 = ( ( temp_output_82_0_g225 * temp_output_85_0_g225 ) + ( temp_output_86_0_g225 * temp_output_89_0_g225 ) );
			half3 appendResult94_g225 = (half3(( ( break80_g225.x * -1.0 ) * temp_output_90_0_g225 ) , ( temp_output_82_0_g225 * temp_output_86_0_g225 ) , ( ( break80_g225.y * -1.0 ) * temp_output_90_0_g225 )));
			half clampResult124_g225 = clamp( appendResult94_g225.y , 0.0 , 10.0 );
			half temp_output_1691_56 = ( clampResult124_g225 * ( ( ( ( ( UNITY_PI * 0.5 ) - ( temp_output_81_0_g225 + -3.8 ) ) % ( UNITY_PI * 2.0 ) ) / UNITY_PI ) + -1.0 ) );
			half clampResult1194 = clamp( temp_output_1691_56 , 0.0 , 1.0 );
			half clampResult1195 = clamp( temp_output_1691_56 , -1.0 , 1.0 );
			half temp_output_61_0_g221 = ( ( UNITY_PI * 2.0 ) / _Gerstner_1_Instance.w );
			...
			half clampResult996 = clamp( temp_output_991_0 , 0.0 , ( temp_output_991_0 / clampResult894 ) );
			half temp_output_67_0_g212 = _Polar_and_Small_Waves_Friction_Depth_Mask_Instance;
			half clampResult135_g212 = clamp( i.uv4_texcoord4.w , 0.0 , temp_output_67_0_g212 );
			half temp_output_81_0_g221 = ( temp_output_61_0_g221 * ( dotResult72_g221 - ( sqrt( ( 9.8 / temp_output_61_0_g221 ) ) * ( ( temp_output_964_0 - ( 0.3 * clampResult996 ) ) - ( pow( abs( (1.0 + (clampResult135_g212 - 0.0) * (0.0 - 1.0) / (temp_output_67_0_g212 - 0.0)) ) , _Polar_and_Small_Waves_Friction_Depth_Mask_Power_Instance ) * _Polar_and_Small_Waves_Friction_Speed_Reduction_Instance ) ) ) ) );
			half temp_output_1687_56 = ( ( ( ( ( UNITY_PI * 0.5 ) - ( temp_output_81_0_g221 + -3.8 ) ) % ( UNITY_PI * 2.0 ) ) / UNITY_PI ) + -1.0 );
			half clampResult1199 = clamp( temp_output_1687_56 , 0.0 , 1.0 );
			half clampResult1200 = clamp( temp_output_1687_56 , -1.0 , 1.0 );
			half temp_output_61_0_g222 = ( ( UNITY_PI * 2.0 ) / _Gerstner_2_Instance.w );
			float cos931 = cos( ( ( temp_output_929_0 + 180.0 ) * 0.01745 ) );
			float sin931 = sin( ( ( temp_output_929_0 + 180.0 ) * 0.01745 ) );
			half2 rotator931 = mul( appendResult967 - float2( 0,0 ) , float2x2( cos931 , -sin931 , sin931 , cos931 )) + float2( 0,0 );
			...
			half clampResult1001 = clamp( temp_output_992_0 , 0.0 , ( temp_output_992_0 / clampResult894 ) );
			half temp_output_67_0_g213 = _Polar_and_Small_Waves_Friction_Depth_Mask_Instance;
			half clampResult135_g213 = clamp( i.uv4_texcoord4.w , 0.0 , temp_output_67_0_g213 );
			half temp_output_81_0_g222 = ( temp_output_61_0_g222 * ( dotResult72_g222 - ( sqrt( ( 9.8 / temp_output_61_0_g222 ) ) * ( ( temp_output_964_0 - ( 0.3 * clampResult1001 ) ) - ( pow( abs( (1.0 + (clampResult135_g213 - 0.0) * (0.0 - 1.0) / (temp_output_67_0_g213 - 0.0)) ) , _Polar_and_Small_Waves_Friction_Depth_Mask_Power_Instance ) * _Polar_and_Small_Waves_Friction_Speed_Reduction_Instance ) ) ) ) );
			half temp_output_1688_56 = ( ( ( ( ( UNITY_PI * 0.5 ) - ( temp_output_81_0_g222 + -3.8 ) ) % ( UNITY_PI * 2.0 ) ) / UNITY_PI ) + -1.0 );
			half clampResult1204 = clamp( temp_output_1688_56 , 0.0 , 1.0 );
			half clampResult1205 = clamp( temp_output_1688_56 , -1.0 , 1.0 );
			...
			half3 Waves710 = i.vertexToFrag1514;
			...
			half lerpResult81 = lerp( SAMPLE_TEXTURE2D( _SlowWaterTesselation, sampler_Linear_Repeat_Aniso8, temp_output_1615_91 ).r , SAMPLE_TEXTURE2D( _SlowWaterTesselation, sampler_Linear_Repeat_Aniso8, temp_output_1615_93 ).r , temp_output_1615_96);
			...
			half3 normalizeResult1433 = normalize( lerpResult481 );
			half3 break42_g152 = normalizeResult1433;
			half3 appendResult14_g152 = (half3(break42_g152.x , break42_g152.y , break42_g152.z));
			half _Distortion_Instance = UNITY_ACCESS_INSTANCED_PROP(_Distortion_arr, _Distortion);
			half temp_output_45_0_g152 = _Distortion_Instance;
			half3 temp_output_38_0_g152 = ( appendResult14_g152 * temp_output_45_0_g152 );
			half2 appendResult20_g152 = (half2(_ScreenParams.x , _ScreenParams.y));
			half2 temp_output_23_0_g152 = ( half2( 1,1 ) / appendResult20_g152 );
			half eyeDepth18_g152 = LinearEyeDepth(SAMPLE_DEPTH_TEXTURE( _CameraDepthTexture, ( ( floor( ( ( ase_screenPosNorm + half4( temp_output_38_0_g152 , 0.0 ) ) * half4( appendResult20_g152, 0.0 , 0.0 ) ) ) + float4( 0.5,0.5,0,0 ) ) * half4( abs( temp_output_23_0_g152 ), 0.0 , 0.0 ) ).xy ));
			half temp_output_16_0_g152 = ( eyeDepth18_g152 - i.eyeDepth );
			half4 temp_output_35_0_g152 = ( ( floor( ( ase_screenPosNorm * half4( appendResult20_g152, 0.0 , 0.0 ) ) ) + float4( 0.5,0.5,0,0 ) ) * half4( abs( temp_output_23_0_g152 ), 0.0 , 0.0 ) );
			half4 temp_output_22_0_g152 = ( temp_output_35_0_g152 + half4( ( saturate( temp_output_16_0_g152 ) * ( temp_output_38_0_g152 / ase_screenPos.w ) ) , 0.0 ) );
			half4 ifLocalVar30_g152 = 0;
			if( temp_output_16_0_g152 >= 0.0 )
				ifLocalVar30_g152 = temp_output_22_0_g152;
			else
				ifLocalVar30_g152 = temp_output_35_0_g152;
			half4 temp_output_1614_0 = ifLocalVar30_g152;
			half4 screenColor352 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_GrabTexture,temp_output_1614_0.xy);
			...
			half temp_output_44_0_g145 = _Caustic_Falloff_Instance;
			half3 appendResult34_g145 = (half3(temp_output_44_0_g145 , temp_output_44_0_g145 , temp_output_44_0_g145));
			half _Caustic_Tiling_Instance = UNITY_ACCESS_INSTANCED_PROP(_Caustic_Tiling_arr, _Caustic_Tiling);
			half temp_output_42_0_g145 = _Caustic_Tiling_Instance;
			half2 temp_cast_15 = (temp_output_42_0_g145).xx;
			...
			half temp_output_43_0_g145 = _Caustic_Triplanar_Hardness_Instance;
			half _Caustic_Speed_Instance = UNITY_ACCESS_INSTANCED_PROP(_Caustic_Speed_arr, _Caustic_Speed);
			half temp_output_14_0_g145 = ( _Caustic_Speed_Instance * _Time.y );
			half3 appendResult16_g145 = (half3(temp_output_14_0_g145 , temp_output_14_0_g145 , temp_output_14_0_g145));
			half4 temp_output_38_0_g145 = temp_output_1614_0;
			half4 temp_output_76_0_g148 = temp_output_38_0_g145;
			half2 UV22_g149 = temp_output_76_0_g148.xy;
			half2 localUnStereo22_g149 = UnStereo( UV22_g149 );
			half2 break64_g148 = localUnStereo22_g149;
			half clampDepth69_g148 = SAMPLE_DEPTH_TEXTURE( _CameraDepthTexture, temp_output_76_0_g148.xy );
			#ifdef UNITY_REVERSED_Z
				float staticSwitch38_g148 = ( 1.0 - clampDepth69_g148 );
			#else
				float staticSwitch38_g148 = clampDepth69_g148;
			#endif
			half3 appendResult39_g148 = (half3(break64_g148.x , break64_g148.y , staticSwitch38_g148));
			half4 appendResult42_g148 = (half4((appendResult39_g148*2.0 + -1.0) , 1.0));
			half4 temp_output_43_0_g148 = mul( unity_CameraInvProjection, appendResult42_g148 );
			half3 temp_output_46_0_g148 = ( (temp_output_43_0_g148).xyz / (temp_output_43_0_g148).w );
			half3 In72_g148 = temp_output_46_0_g148;
			half3 localInvertDepthDir72_g148 = InvertDepthDir72_g148( In72_g148 );
			half4 appendResult49_g148 = (half4(localInvertDepthDir72_g148 , 1.0));
			half4 temp_output_48_0_g145 = mul( unity_CameraToWorld, appendResult49_g148 );
			float4 triplanar25_g145 = TriplanarSampling25_g145( _Caustic, sampler_Caustic, ( half4( ( appendResult16_g145 * float3( 0.76,0.73,0.79 ) ) , 0.0 ) + temp_output_48_0_g145 ).xyz, ase_worldNormal, temp_output_43_0_g145, temp_cast_15, 1.0, 0 );
			half3 appendResult35_g145 = (half3(triplanar25_g145.xyz));
			half2 temp_cast_20 = (temp_output_42_0_g145).xx;
			half temp_output_17_0_g145 = ( temp_output_14_0_g145 * -1.07 );
			half3 appendResult21_g145 = (half3(temp_output_17_0_g145 , temp_output_17_0_g145 , temp_output_17_0_g145));
			float4 triplanar26_g145 = TriplanarSampling26_g145( _Caustic, sampler_Caustic, ( half4( appendResult21_g145 , 0.0 ) + temp_output_48_0_g145 ).xyz, ase_worldNormal, temp_output_43_0_g145, temp_cast_20, 1.0, 0 );
			half3 appendResult36_g145 = (half3(triplanar26_g145.xyz));
			half3 clampResult37_g145 = clamp( ( appendResult34_g145 * min( appendResult35_g145 , appendResult36_g145 ) ) , float3( 0,0,0 ) , float3( 1,1,1 ) );
			...
			half4 lerpResult425 = lerp( temp_output_415_0 , ( ( temp_output_415_0 / _Caustic_Intensivity_Instance ) + ( pow( abs( ( _Caustic_Color_Instance * half4( clampResult37_g145 , 0.0 ) ) ) , temp_cast_25 ) * _Caustic_Intensivity_Instance ) ) , _Caustic_Blend_Instance);
			#ifdef _USE_CAUSTIC
			...
			half3 temp_output_41_0_g153 = temp_output_1614_0.xyz;
			half clampDepth36_g153 = SAMPLE_DEPTH_TEXTURE( _CameraDepthTexture, half4( temp_output_41_0_g153 , 0.0 ).xy );
			half temp_output_16_0_g153 = ( _ProjectionParams.x < 0.0 ? clampDepth36_g153 : ( 1.0 - clampDepth36_g153 ) );
			half temp_output_31_0_g153 = saturate( ( (_ProjectionParams.z + (temp_output_16_0_g153 - 0.0) * (_ProjectionParams.y - _ProjectionParams.z) / (1.0 - 0.0)) - i.eyeDepth ) );
			half eyeDepth39_g153 = LinearEyeDepth(SAMPLE_DEPTH_TEXTURE( _CameraDepthTexture, half4( temp_output_41_0_g153 , 0.0 ).xy ));
			half ifLocalVar40_g153 = 0;
			UNITY_BRANCH 
			if( unity_OrthoParams.w >= 1.0 )
				ifLocalVar40_g153 = temp_output_31_0_g153;
			else
				ifLocalVar40_g153 = ( eyeDepth39_g153 - i.eyeDepth );
			half temp_output_1613_0 = ifLocalVar40_g153;
			...
			half clampResult16 = clamp( saturate( pow( abs( ( temp_output_1613_0 * _ShalowFalloffMultiply_Instance ) ) , ( _ShalowFalloffPower_Instance * -1.0 ) ) ) , 0.0 , 1.0 );
			...
			half clampResult515 = clamp( ( temp_output_1613_0 * _Shore_Translucency_Multiply_Instance ) , 0.0 , 1.0 );
			...
			half clampResult43 = clamp( ( temp_output_1613_0 * _WaterAlphaMultiply_Instance ) , 0.0 , 1.0 );
			...
			half clampResult35 = clamp( ( temp_output_1613_0 * _CleanFalloffMultiply_Instance ) , 0.0 , 1.0 );
			...
			half clampDepth53_g153 = SAMPLE_DEPTH_TEXTURE( _CameraDepthTexture, ase_screenPos.xy );
			half temp_output_52_0_g153 = ( _ProjectionParams.x < 0.0 ? clampDepth53_g153 : ( 1.0 - clampDepth53_g153 ) );
			half temp_output_49_0_g153 = saturate( ( (_ProjectionParams.z + (temp_output_52_0_g153 - 0.0) * (_ProjectionParams.y - _ProjectionParams.z) / (1.0 - 0.0)) - i.eyeDepth ) );
			half eyeDepth44_g153 = LinearEyeDepth(SAMPLE_DEPTH_TEXTURE( _CameraDepthTexture, ase_screenPosNorm.xy ));
			half ifLocalVar46_g153 = 0;
			UNITY_BRANCH 
			if( unity_OrthoParams.w >= 1.0 )
				ifLocalVar46_g153 = temp_output_49_0_g153;
			else
				ifLocalVar46_g153 = ( eyeDepth44_g153 - i.eyeDepth );
			half _EdgeFalloffMultiply_Instance = UNITY_ACCESS_INSTANCED_PROP(_EdgeFalloffMultiply_arr, _EdgeFalloffMultiply);
			half clampResult4 = clamp( ( ifLocalVar46_g153 * _EdgeFalloffMultiply_Instance ) , 0.0 , 1.0 );
			...
			half clampResult1531 = clamp( lerpResult1297 , 0.0 , 1.0 );
			#ifdef DIRECTIONAL_COOKIE
				half staticSwitch1530 = clampResult1531;
			#else
				half staticSwitch1530 = 1.0;
			#endif
			o.Albedo = ( lerpResult1298 * staticSwitch1530 ).rgb;
			...
			half3 temp_cast_32 = (( lerpResult613 * staticSwitch1530 )).xxx;
			...
			o.Occlusion = ( _AOPower_Instance * staticSwitch1530 );
			o.Alpha = clampResult1531;
		}
